...
public class BitmapUtils {
  ...
  private static Bitmap rotateBitmap(
    ...
    Log.d("getBitmapFromContentUri", "rotatedBitmap = " + rotatedBitmap);
  ...
  public static Bitmap getBitmapFromContentUri(ContentResolver contentResolver, Uri imageUri)
    ...
    if (decodedBitmap == null) {
      Log.d("getBitmapFromContentUri", "decodedBitmap == null");
      return null;
    }
    ...
    Log.d("getBitmapFromContentUri", "flipX = " + flipX);
    Log.d("getBitmapFromContentUri", "flipY = " + flipY);
    Log.d("getBitmapFromContentUri", "rotationDegrees = " + rotationDegrees);
    Log.d("getBitmapFromContentUri", "rotationDegrees = " + decodedBitmap.toString());
